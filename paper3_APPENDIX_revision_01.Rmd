...
- models for relevance for center (air-pollution).

```{r, echo=FALSE, warning=FALSE, message=F}

mod_relevance_null.a = lm(TRUST_air_INDEX~1,data=SVIVA2_01_comb %>% filter(AREA_center==1))
mod_relevance_1.1.a = update(mod_relevance_null.a,. ~ .+
                             SYMBOL_t+
                   INFORMATION_weak+
                   RELEVANCE_exp)
mod_relevance_1.2.a = update(mod_relevance_1.1.a,. ~ .+RELEVANCE_exp*(SYMBOL_t+INFORMATION_weak))
mod_relevance_1.3.a = update(mod_relevance_1.2.a,. ~ .+
                   GENDER+
                   AGE+
                   GOV_TRUST+
                   IDEOLOGY+
...
mod_relevance_1.4.a = update(mod_relevance_1.2.a,. ~ .,data=SVIVA2_01_comb.center_air_first)


## Adjust standard errors & F statistic
mod_relevance_1.1.a.robust_se    <- sqrt(diag(vcovHC(mod_relevance_1.1.a, type = "HC1")))
mod_relevance_1.1.a.wald_results <- waldtest(mod_relevance_1.1.a, vcov = vcovHC(mod_relevance_1.1.a, type = "HC1"))

mod_relevance_1.2.a.robust_se    <- sqrt(diag(vcovHC(mod_relevance_1.2.a, type = "HC1")))
mod_relevance_1.2.a.wald_results <- waldtest(mod_relevance_1.2.a, vcov = vcovHC(mod_relevance_1.2, type = "HC1"))

mod_relevance_1.3.a.robust_se    <- sqrt(diag(vcovHC(mod_relevance_1.3.a, type = "HC1")))
mod_relevance_1.3.a.wald_results <- waldtest(mod_relevance_1.3.a, vcov = vcovHC(mod_relevance_1.3, type = "HC1"))

mod_relevance_1.4.a.robust_se    <- sqrt(diag(vcovHC(mod_relevance_1.4.a, type = "HC1")))
mod_relevance_1.4.a.wald_results <- waldtest(mod_relevance_1.4.a, vcov = vcovHC(mod_relevance_1.3, type = "HC1"))
...
stargazer(mod_relevance_1.1.a,mod_relevance_null.a,
          mod_relevance_1.2.a,mod_relevance_null.a,
          mod_relevance_1.3.a, mod_relevance_null.a,
          mod_relevance_1.4.a, mod_relevance_null.a,
          type = "html",
          se  = list(mod_relevance_1.1.a.robust_se,NULL,
                     mod_relevance_1.2.a.robust_se,NULL,
                     mod_relevance_1.3.a.robust_se,NULL,
                     mod_relevance_1.4.a.robust_se,NULL),
          style = "apsr",
          report = "vcsp",
          omit.stat = c("rsq","ser", "f"),
          initial.zero = FALSE,
          ...
          add.lines = list(
                           ...
                           c("F Statistic", 
                             mod_relevance_1.1.a.wald_results[2,3] %>% round(2),NA,
                             mod_relevance_1.2.a.wald_results[2,3] %>% round(2),NA,
                             mod_relevance_1.3.a.wald_results[2,3] %>% round(2),NA,
                             mod_relevance_1.4.a.wald_results[2,3] %>% round(2),NA)),
...
- Models for relevance for both groups for recycling. 
- replicating all regression tables for upfilterred sample. 
...
In the tables below, I report the results of additional robust analyses testing the moderating role of the perceived personal relevance of the communications. 
...
**Table A10: Regression table - subjective reporting of perceived personal relevance**
