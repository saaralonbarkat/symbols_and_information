...
A growing body of public administration research seeks to assess whether and how government organizations can increse citizens' trust through direct communications with citizens. This study contributes to this discussion, by pointing to the influence of symbolic elements in public communications, and unpacking the theoretical mechanisms underlying their effect on citizens' trust. Using a rigorous experimental design, embedded in a realistic setting of communication of policy plans of the Israeli Environmental Protection Ministry, I tested the effect of symbolic elements on trust, and its interactions with the substantive content of the communications and with their perceived personal relevance. The experimental results demonstrate that using familiar symbolic elements in communications about policy plans increase citizens' trust in these policies, via two mechanisms: First, they evoke positive fellings that are transferred to the policy plan. Second, by putting citizens in a positive mood, they distract them from thinking about the substantive content of the communication, and thus - they cause them to disregard its weaknesses, if exist. the latter mechanism entails an interaction between symbols and weak information. These theoretical mechanisms can be understood in light of the social psychology elaboration likelihood model. In addition, I theorized that the effect of symbols is attenuated the more the communication is personally relevant for citizens' lives, but the reults do not support this expectation. Rather, I found that citizens who perceived the policy issue as highly relevant for their lives (i.e. air-pollution in their area of residence), were similarly distracted by the graphic symbols, and persuaded to trust governmnet's actions, even when they were undoubtedly illogical. These findings are based on a large sample of more than `r (SVIVA2_01%>%nrow() %>% round(-2))-100` participants, and are robust for various model specifications. 

What are the implications of these findings for public administation resarch? First, they highlight the important role of strategically designed symbolic elements in communications in shaping citizens' attitudes about government. Citizens' responses to symbolic elements and branding thus far received relatively little attention in Public administration literature, compared with the the abounded research on responses to information. Yet, this study, and others, demonstrated that symbols can be fairly effective in increasing citizens' trust, and mitigating their negative attitudes [@alonbarkat_2017; @karens_2016; @teodoro_2018]. Furthermore, this study demostrates that symbols decrease the "rational", systematic processing of substantive information. This may suggest that government organizations may bypass the cognitive biases that often undermine the effectiveness of positive information, by employing symbolic communication.[^footnote_biases_ELM] This is good news as far as we are concerned mainly about citizens' *undervaluation* of government performance. On the other hand, it challenges the democratic ideal that citizens' form their attitudes about governments on the basis of rational thinking [###Dahl...]. Moreover, it suggests that public organizations may use symbols in communications to compensate for their poor performance and inefficient policy plans. In turn, by preserving citizens' trust in them and escaping from public blame, organizations can nurture their long-term positive reputation, which attenuates politicians' incentives to monitor and oversight them [##Busuioc_2016; Bertelli_2018##]. Overall... something about democratic accountability... 

[^footnote_biases_ELM]: This posibility is supported, theoretically, by ELM. According to ELM, biased processing occures in the central route, whereby people give unproportional weight for strong or weak arguments. Accordingly, decresaing the ammount of thinking may also decrease biased processing [@petty_1986]. Future research might put this expectation to test. 

Methodologically, these findings highlight that it is important to test the effectiveness of public communications, and not only the information.  

Almost any government communication involves design elements, and many of them include familiar symbols and brand elements. Conversely, some of the current studies that explored the effect of information, did so by comparing participants' responses to pieces of information (mainly favorable vs. unfavorable performance) which were presented in surveys in the form of plain text and data tables without design elements which would be normally included in  such communications [@baekgaard_2016; @hvidman_2016; ]. This questions our ability to generalize from these experiments to citizens' responses to public communications in the real world.  

Finally, PA can also implement ELM...
